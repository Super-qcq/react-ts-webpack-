...
import type { Todo, PageParams } from '../../../types';
...
class TodoTable extends React.Component<object, TodoTableState> {
  ...
  fetchData = (): void => {
    ...
    const params: PageParams = { _limit: 10, _page: currentPage };
  ...
  render(): React.ReactNode {
    const { data, loading, currentPage, filter, total } = this.state;
    ...
    return (
      <div className="todo-list">
        <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
          ...
          <Col xs={24} sm={6}>
            <Card hoverable className="progress-card">
